      ...
      <div className="AboutYou">
        <div className="FormGroupe">
          ...
          <input
            ...
            className={
              formik.touched.name && formik.errors.name ? "InputRed" : "Input"
            }
          />
        ...
        <div className="FormGroupe">
          ...
          <input
            ...
            placeholder="+__ _ _______"
            className={
              formik.touched.tel && formik.errors.tel ? "InputRed" : "Input"
            }
          />
  ...
  if (props.AboutAJorney) {
    component = (
      <div className="AboutYou">
        <div className="FormGroupe">
          <label htmlFor="place">
            When and where you wan to go? {props.star}
          </label>
          <input
            type="text"
            name="place"
            ...
            placeholder="Continent, country of city"
            className={
              formik.touched.place && formik.errors.place ? "InputRed" : "Input"
            }
          />
        ...
        <div className="FormGroupe">
          ...
          <input
            ...
            placeholder="Date or time interval"
            className="Input"
          />
        </div>
      </div>
